...
export default {
  ...
  methods: {
      ...
      addComment: function() {
        ...
        axios.post('http://ec2-3-237-88-193.compute-1.amazonaws.com:8000/createcomment/', commentObj)
  ...
  async mounted() {
    try {
        ...
        axios.get('http://ec2-3-237-88-193.compute-1.amazonaws.com:8000/getcomments', {
          params: {
            post_id: this.post.post_id
          }
        }).then(response => {
